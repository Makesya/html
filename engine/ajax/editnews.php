...
setTimeout(function() {
	...
	tinymce.init({
		...
		style_formats: [
			...
			{ title: 'Use a shadow', block: 'div', styles: { 'box-shadow': 'rgb(0 0 0 / 24%) 0px 1px 2px' } },
		...
		quickbars_selection_toolbar: 'bold italic underline quicklink | dlequote dlespoiler dlehide | forecolor backcolor styles blocks fontsize lineheight',
